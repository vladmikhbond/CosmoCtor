...
solv:
`<p>\\( v=\\sqrt{GM \\over r} \\)
З вихідних даних \\( M = 10^4;    G = 1;    r=400; \\);   
Обчислюємо швидкість планети: \\( v=\\sqrt{10000 \\over 400}= 5 \\) .    
В моделі швидкості задаються x і y компонентами, тому в заданому положенні планети v = (0, 5). 
`,
solvPlanets: 
[{"name":"Sun","m":10000,"r":25,"x":0,"y":0,"vx":0,"vy":0,"color":"yellow"},
